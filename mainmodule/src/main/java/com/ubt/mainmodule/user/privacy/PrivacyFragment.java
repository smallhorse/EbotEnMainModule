...
import com.ubt.baselib.customView.BaseGdprDialog;
...
public class PrivacyFragment extends SupportFragment {

    @BindView(R2.id.tv_privacy_cancel)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.main_fragment_privacy, container, false);
...
//        initData();
    ...
    int ck = 1;
    @OnClick(R2.id.tv_privacy_cancel)
    public void onViewClicked() {
        new BaseGdprDialog.Builder(getActivity())
                .setMessage(R.string.policy_notice_text)
                ...
                .setTitle(R.string.policy_notice)
                .setOnDissmissListener(new BaseGdprDialog.OnDissmissListener() {
                    @Override
...
//                            showDialogTip();
                ...
                .setButtonOnClickListener(new BaseGdprDialog.ButtonOnClickListener() {
                    @Override
                ...
                .request(new ACallback<String>() {
                    ...
                    public void onSuccess(String data) {
                        ...
                        if(baseResponseModel.status){
                            ToastUtils.showShort("Account cancellation successful");
                            clearUser();
