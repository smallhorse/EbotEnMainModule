...
package com.ubt.mainmodule.signSeekBar;
...
import static com.ubt.mainmodule.signSeekBar.SignSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.ubt.mainmodule.signSeekBar.SignSeekBar.TextPosition.BOTTOM_SIDES;
import static com.ubt.mainmodule.signSeekBar.SignSeekBar.TextPosition.SIDES;
...
public class SignSeekBar extends View {
    ...
    public SignSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.mainSignSeekBar, defStyleAttr, 0);
        mMin = a.getFloat(R.styleable.mainSignSeekBar_main_min, 0.0f);
        mMax = a.getFloat(R.styleable.mainSignSeekBar_main_max, 100.0f);
        mProgress = a.getFloat(R.styleable.mainSignSeekBar_main_progress, mMin);
        isFloatType = a.getBoolean(R.styleable.mainSignSeekBar_main_is_float_type, false);
        mTrackSize = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_track_size, SignUtils.dp2px(2));
        mTextSpace = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_text_space, SignUtils.dp2px(2));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_second_track_size, mTrackSize + SignUtils.dp2px(2));
        mThumbRadius = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_thumb_radius, mSecondTrackSize + SignUtils.dp2px(2));
        mThumbRadiusOnDragging = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_thumb_radius, mSecondTrackSize * 2);
        mSignBorderSize = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_sign_border_size, SignUtils.dp2px(1));
        mSectionCount = a.getInteger(R.styleable.mainSignSeekBar_main_section_count, 10);
        mTrackColor = a.getColor(R.styleable.mainSignSeekBar_main_track_color, ContextCompat.getColor(context, R.color.colorPrimary));
        mSecondTrackColor = a.getColor(R.styleable.mainSignSeekBar_main_second_track_color, ContextCompat.getColor(context, R.color.colorAccent));
        mThumbColor = a.getColor(R.styleable.mainSignSeekBar_main_thumb_color, mSecondTrackColor);
        isShowSectionText = a.getBoolean(R.styleable.mainSignSeekBar_main_show_section_text, false);
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_section_text_size, SignUtils.sp2px(14));
        mSectionTextColor = a.getColor(R.styleable.mainSignSeekBar_main_section_text_color, mTrackColor);
        isSeekBySection = a.getBoolean(R.styleable.mainSignSeekBar_main_seek_by_section, false);
        int pos = a.getInteger(R.styleable.mainSignSeekBar_main_section_text_position, NONE);
        if (pos == 0) {
        ...
        mSectionTextInterval = a.getInteger(R.styleable.mainSignSeekBar_main_section_text_interval, 1);
        isShowThumbText = a.getBoolean(R.styleable.mainSignSeekBar_main_show_thumb_text, false);
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_thumb_text_size, SignUtils.sp2px(14));
        mThumbTextColor = a.getColor(R.styleable.mainSignSeekBar_main_thumb_text_color, mSecondTrackColor);
        mSignColor = a.getColor(R.styleable.mainSignSeekBar_main_sign_color, mSecondTrackColor);
        mSignBorderColor = a.getColor(R.styleable.mainSignSeekBar_main_sign_border_color, mSecondTrackColor);
        mUnusableColor = a.getColor(R.styleable.mainSignSeekBar_main_unusable_color, Color.GRAY);
        mSignTextSize = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_sign_text_size, SignUtils.sp2px(14));
        mSignHeight = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_sign_height, SignUtils.dp2px(32));
        mSignWidth = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_sign_width, SignUtils.dp2px(72));
        mSignArrowHeight = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_sign_arrow_height, SignUtils.dp2px(3));
        mSignArrowWidth = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_sign_arrow_width, SignUtils.dp2px(5));
        mSignRound = a.getDimensionPixelSize(R.styleable.mainSignSeekBar_main_sign_round, SignUtils.dp2px(3));
        mSignTextColor = a.getColor(R.styleable.mainSignSeekBar_main_sign_text_color, Color.WHITE);
        isShowSectionMark = a.getBoolean(R.styleable.mainSignSeekBar_main_show_section_mark, false);
        isAutoAdjustSectionMark = a.getBoolean(R.styleable.mainSignSeekBar_main_auto_adjust_section_mark, false);
        isShowProgressInFloat = a.getBoolean(R.styleable.mainSignSeekBar_main_show_progress_in_float, false);
        int duration = a.getInteger(R.styleable.mainSignSeekBar_main_anim_duration, -1);
        mAnimDuration = duration < 0 ? 200 : duration;
        isTouchToSeek = a.getBoolean(R.styleable.mainSignSeekBar_main_touch_to_seek, false);
        isShowSignBorder = a.getBoolean(R.styleable.mainSignSeekBar_main_sign_show_border, false);

        int labelsResId = a.getResourceId(R.styleable.mainSignSeekBar_main_sides_labels, 0);
        mThumbBgAlpha = a.getFloat(R.styleable.mainSignSeekBar_main_thumb_bg_alpha, 0.2f);
        mThumbRatio = a.getFloat(R.styleable.mainSignSeekBar_main_thumb_ratio, 0.7f);
        isShowThumbShadow = a.getBoolean(R.styleable.mainSignSeekBar_main_show_thumb_shadow, false);
        isShowSign = a.getBoolean(R.styleable.mainSignSeekBar_main_show_sign, false);
        isSignArrowAutofloat = a.getBoolean(R.styleable.mainSignSeekBar_main_sign_arrow_autofloat, true);
        a.recycle();
